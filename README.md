...
> 📌 Em `src/` estão as classes Java implementadas para o desafio (ex: cursos, mentorias, bootcamp, devs, etc.).

---

## 🧩 Objetivos do Desafio

✔️ Praticar os princípios da **POO**  
✔️ Criar classes com atributos e métodos bem definidos  
✔️ Aplicar **encapsulamento** com getters e setters  
✔️ Explorar **herança** e **polimorfismo** sempre que possível  
✔️ Produzir código limpo e de fácil manutenção  
